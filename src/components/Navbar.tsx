  ...
  return (
    <nav className="flex justify-between items-center fixed z-50 w-full bg-dark-1 px-6 py-4 lg:px-10">
      <Link href="/" className="flex items-center gap-1">
        <Image src="/images/yoom-logo-2.png" width={42} height={42} alt="yoom logo" className="max-sm:size-10" />
        <span className="text-[26px] font-extrabold text-white max-sm:hidden">YOOM</span>
      </Link>
